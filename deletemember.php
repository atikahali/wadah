...
<body>
	...
	<div class="jumbotron">
		...
		if (isset($_GET['ic_ahli'])) {
			$ic_ahli = addslashes($_GET['ic_ahli']);
									
			$idwadah_ahli = addslashes($_GET['idwadah_ahli']);
						
			$nama_ahli = addslashes($_GET['nama_ahli']);
			
			$usrah_ahli = addslashes($_GET['usrah_ahli']);

			include 'dbconnect.php';
			
			$query = "DELETE FROM ahli where ic_ahli = $ic_ahli";
